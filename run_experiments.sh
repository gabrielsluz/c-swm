...
for num_objs in 2 5 10 15 20 25; do
  for num_epochs in 10 20; do
    python3 train.py --dataset /datasets/c_swm_data/mmnist_train.h5 --encoder large --embedding-dim 10 --num-objects $num_objs --epochs $num_epochs --name mmnist --ignore-action --batch-size 512
